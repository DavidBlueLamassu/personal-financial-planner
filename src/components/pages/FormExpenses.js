...
class FormExpenses extends React.Component {
    ...
    handleSubmit = (event) => {
        ...
        if (isNaN(numberExpenses) || numberExpenses === "") {
            alert("Please enter only numbers for expenses (no letters, symbols or blanks)."); 
            return; 
        } 
        if (expensesTitle === "") {
    ...
    render() {
        return(
            ...
            <p>Please submit all your expenses, with identifying names, for the month of {lastMonth}. Please click "Submit" after you have entered
            each source of income.  You may enter as many sources as you wish. When you have finished click "Save". Then click "Finish".</p>
            <article>
            <label className="col-lg-4 col-md-6 col-sm-12">
              <p>Expenses Name (Rent etc.):</p>
              <input
                type="text"
                name="expensesName"
              />
            ...
            <button type="reset" onClick={expensesFunction}>Save</button>
...
function expensesFunction() {
    ...
    alert(`Please click "Finish", then click "Review" in the main menu. You may then view you financial analysis in Charts, Forecasts and Summary.`)
}
